...
const topicArn = process.env.restaurant_notification_topic || 'arn:aws-cn:sns:cn-north-1:834095994034:restaurant-notification';


module.exports.handler = co.wrap(function* (event, context, cb) {
  console.log('receive a event notify-restaurant');
